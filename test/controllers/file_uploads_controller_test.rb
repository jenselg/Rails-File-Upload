...
class FileUploadsControllerTest < ActionController::TestCase
  ...
  test "should create file_upload" do
    assert_difference('FileUpload.count') do
      post :create, file_upload: { file_attachment: @file_upload.file_attachment, file_name: @file_upload.file_name }
    end
  ...
  test "should update file_upload" do
    patch :update, id: @file_upload, file_upload: { file_attachment: @file_upload.file_attachment, file_name: @file_upload.file_name }
    assert_redirected_to file_upload_path(assigns(:file_upload))
  end
